...
public class GuiDragonPhase extends GuiScreen {
	...
	public GuiDragonPhase(GuiScreen screen) {
		EntityDragon dragon = Minecraft.getMinecraft().integratedServer.getWorld(Minecraft.getMinecraft().player.dimension).getEntities(EntityDragon.class, Predicates.alwaysTrue()).get(0);
	...
	public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        drawCenteredString(mc.fontRenderer, translation.get(dragonPhase.getClass().getSimpleName()), width / 2, 10, 0xFFFFFF);
