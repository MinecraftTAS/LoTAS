...
public class GuiLeaderboard extends GuiScreen {
	...
	public class GuiLeaderboardSlot extends GuiSlot {
		...
		protected void drawSlot(int entryID, int p_180791_2_, int p_180791_3_, int p_180791_4_, int mouseXIn,
            ...
            GuiLeaderboard.this.drawString(GuiLeaderboard.this.fontRendererObj, runner, p_180791_2_ + 2, p_180791_3_ + 1, entryID % 2 == 0 ? 16777215 : 9474192);
            String time = Timer.getDuration(Duration.ofMillis(Integer.parseInt(ChallengeLoader.map.leaderboard[entryID].split(";")[1])));
            GuiLeaderboard.this.drawString(GuiLeaderboard.this.fontRendererObj, time, p_180791_2_ + 2 + 213 - GuiLeaderboard.this.fontRendererObj.getStringWidth(time), p_180791_3_ + 1, entryID % 2 == 0 ? 16777215 : 9474192);
