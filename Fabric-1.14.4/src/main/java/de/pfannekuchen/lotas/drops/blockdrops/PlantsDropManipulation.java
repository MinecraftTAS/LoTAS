...
public class PlantsDropManipulation extends DropManipulatorScreen.DropManipulation {
    ...
    public List<ItemStack> redirectDrops(BlockState blockstate) {
        ...
        if (block.getDefaultState().getBlock() == Blocks.CARROTS && optimizeCarrots.isChecked()) {
            if (blockstate.get(IntProperty.of("age", 0, 7)) == 7) return ImmutableList.of(new ItemStack(Items.CARROT, 5));
        } else if (block.getDefaultState().getBlock() == Blocks.POTATOES && optimizePotato.isChecked()) {
            if (blockstate.get(IntProperty.of("age", 0, 7)) == 7) return ImmutableList.of(new ItemStack(Items.POTATO, 5), new ItemStack(Items.POISONOUS_POTATO, 1));
        } else if (block.getDefaultState().getBlock() == Blocks.WHEAT && optimizeWheat.isChecked()) {
            if (blockstate.get(IntProperty.of("age", 0, 7)) == 7) return ImmutableList.of(new ItemStack(Items.WHEAT_SEEDS, 3), new ItemStack(Items.WHEAT, 1));
        } else if (block.getDefaultState().getBlock() == Blocks.BEETROOTS && optimizeBeetroot.isChecked()) {
            if (blockstate.get(IntProperty.of("age", 0, 3)) == 3) return ImmutableList.of(new ItemStack(Items.BEETROOT, 1), new ItemStack(Items.BEETROOT_SEEDS, 4));
            ...
            if (blockstate.get(IntProperty.of("age", 0, 2)) == 2) return ImmutableList.of(new ItemStack(Items.COCOA_BEANS, 3));
            ...
            if (blockstate.get(IntProperty.of("age", 0, 3)) == 3) return ImmutableList.of(new ItemStack(Items.NETHER_WART, 4));
        } else if (block.getDefaultState().getBlock() == Blocks.SWEET_BERRY_BUSH && optimizeSweetBerry.isChecked()) {
            if (blockstate.get(IntProperty.of("age", 0, 3)) == 3) return ImmutableList.of(new ItemStack(Items.SWEET_BERRIES, 3));
            else if (blockstate.get(IntProperty.of("age", 0, 3)) == 2) return ImmutableList.of(new ItemStack(Items.SWEET_BERRIES, 2));
        }
