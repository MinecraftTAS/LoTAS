...
public class MonsterDropManipulation extends LootManipulationScreen.DropManipulation {
    ...
    public List<ItemStack> redirectDrops(Entity entity) {
        ...
        if (entity instanceof SlimeEntity && optimizeSlime.isChecked())
            if (((SlimeEntity) entity).getSize() == 1) { return ImmutableList.of(new ItemStack(Items.SLIME_BALL, 2)); }
        if (entity instanceof SlimeEntity && optimizeSlime.isChecked())
            if (((SlimeEntity) entity).getSize() == 1) return ImmutableList.of(new ItemStack(Items.SLIME_BALL, 2));
