...
public class DeadbushDropManipulation extends LootManipulationScreen.DropManipulation {
    ...
    public List<ItemStack> redirectDrops(BlockState block) {
        if (block.getBlock().getDefaultState().getBlock() != Blocks.DEAD_BUSH) return ImmutableList.of();
