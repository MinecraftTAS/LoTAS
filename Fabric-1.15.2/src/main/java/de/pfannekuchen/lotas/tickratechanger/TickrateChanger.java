...
public class TickrateChanger {
	...
	public static void onDraw() {
		if (TickrateChanger.tickrate <= 5 && showTickIndicator && ConfigManager.getBoolean("tools", "showTickIndicator")) {
			MinecraftClient.getInstance().getTextureManager().bindTexture(new Identifier("textures/gui/stream_indicator.png"));
			Screen.blit(MinecraftClient.getInstance().getWindow().getScaledWidth() - 17, 1, 0, 0, 16, 16, 16, 64);
		}
	}
}
