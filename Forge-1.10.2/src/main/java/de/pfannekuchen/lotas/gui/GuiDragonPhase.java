...
public class GuiDragonPhase extends GuiScreen {
	...
	public GuiDragonPhase(GuiScreen screen) {
		EntityDragon dragon = Minecraft.getMinecraft().theIntegratedServer.worldServerForDimension(Minecraft.getMinecraft().thePlayer.dimension).getEntities(EntityDragon.class, Predicates.alwaysTrue()).get(0);
	...
	public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        drawCenteredString(mc.fontRendererObj, translation.get(dragonPhase.getClass().getSimpleName()), width / 2, 10, 0xFFFFFF);
