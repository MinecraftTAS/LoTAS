...
public class SealanternDropManipulation extends GuiLootManipulation.DropManipulation {
    ...
    public void update() {
        ...
        drop2Pris.xPosition = x;
        drop2Pris.yPosition = y + 96;
        drop3Pris.xPosition = x;
        drop3Pris.yPosition = y + 120;
    ...
    public void render(int mouseX, int mouseY, float delta) {
        ...
        if (!enabled.isChecked()) {
            ...
            Minecraft.getMinecraft().fontRendererObj.drawStringWithShadow("Drop " + pris + " Prismarine Crystals when breaking Sea Lanterns", x, y + 64, 0xFFFFFF);
