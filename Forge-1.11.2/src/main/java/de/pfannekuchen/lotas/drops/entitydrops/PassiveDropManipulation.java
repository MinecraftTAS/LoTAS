...
public class PassiveDropManipulation extends GuiLootManipulation.DropManipulation {
    ...
    public void update() {
        ...
        optimizeSkeletonhorse.yPosition = 80;
        ...
        optimizePolarbear.yPosition = 160;
        optimizeChicken.xPosition = x;
        optimizeSkeletonhorse.xPosition = x;
    ...
    public void render(int mouseX, int mouseY, float delta) {
        ...
        if (!enabled.isChecked()) {
            ...
            optimizeSkeletonhorse.drawButton(Minecraft.getMinecraft(), mouseX, mouseY);
