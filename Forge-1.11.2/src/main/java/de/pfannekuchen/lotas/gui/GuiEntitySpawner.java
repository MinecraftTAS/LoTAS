...
public class GuiEntitySpawner extends GuiScreen {
	...
	protected void mouseClicked(int mouseX, int mouseY, int mouseButton) throws IOException {
		...
		e = entity.getEntity(mc.theIntegratedServer.worldServerForDimension(mc.player.dimension));
	...
	protected void actionPerformed(GuiButton button) throws IOException {
		...
		case 12:
			...
			break;
		case 69:
			Minecraft.getMinecraft().theIntegratedServer.worldServerForDimension(mc.player.dimension).spawnEntity(e);
		default:
			break;
		}
