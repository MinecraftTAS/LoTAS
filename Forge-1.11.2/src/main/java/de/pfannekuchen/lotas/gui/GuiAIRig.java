...
public class GuiAIRig extends GuiScreen {
	...
	public void initGui() {
		...
		entities = mc.getIntegratedServer().worldServerForDimension(mc.player.dimension).getEntitiesWithinAABB(EntityLiving.class, mc.player.getEntityBoundingBox().expand(32, 32, 32));
