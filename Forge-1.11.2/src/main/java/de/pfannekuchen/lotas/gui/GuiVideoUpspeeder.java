...
public class GuiVideoUpspeeder extends GuiScreen implements IProgressMeter {
	...
	@Override
	public void initGui() {
		text = new GuiTextField(0, mc.fontRendererObj, (width / 12) * 1 - (width / 24), (height / 8), (width / 12) * 9, 20);
		...
		tickrate = new GuiTextField(4, mc.fontRendererObj, (width / 2) - 45, (height / 8) * 2 + 23, 90, 14);
		tickrate.setText("20");
		super.initGui();
	}
