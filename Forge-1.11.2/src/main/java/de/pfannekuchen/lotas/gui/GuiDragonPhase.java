...
public class GuiDragonPhase extends GuiScreen {
	...
	public GuiDragonPhase(GuiScreen screen) {
		EntityDragon dragon = Minecraft.getMinecraft().theIntegratedServer.worldServerForDimension(Minecraft.getMinecraft().player.dimension).getEntities(EntityDragon.class, Predicates.alwaysTrue()).get(0);
