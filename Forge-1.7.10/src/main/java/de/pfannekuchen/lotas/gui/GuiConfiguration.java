...
import de.pfannekuchen.lotas.gui.parts.GuiTextFieldId;
...
public class GuiConfiguration extends GuiScreen {
	...
	public ArrayList<GuiTextFieldId> strings = new ArrayList<GuiTextFieldId>();
	public ArrayList<GuiTextFieldId> ints = new ArrayList<GuiTextFieldId>();
	...
	protected void actionPerformed(GuiButton button)  {
		if (optionsBoolean[button.id].startsWith("B:")) {
			...
			ConfigManager.setBoolean(optionsBoolean[button.id].split(":")[1], optionsBoolean[button.id].split(":")[2], Boolean.parseBoolean(optionsBoolean[button.id].split(":")[3]));
			ConfigManager.save();
		}
		initGui();
	...
	protected void keyTyped(char typedChar, int keyCode)  {
		for (GuiTextFieldId field : strings) {
