...
public class ZombieDropManipulation extends GuiLootManipulation.DropManipulation {
    ...
    public static ImageButton dropIron = new ImageButton(x, y, new PressAction() {
		@Override
		public void trigger(ButtonWidget c) {
    ...
    public static ImageButton dropPotato = new ImageButton(x, y, new PressAction() {
		@Override
		public void trigger(ButtonWidget c) {
    ...
    public static ImageButton dropCarrot = new ImageButton(x, y, new PressAction() {
		@Override
		public void trigger(ButtonWidget c) {
		    ZombieDropManipulation.dropIron.setToggled(false);
		    ZombieDropManipulation.dropPotato.setToggled(false);
    ...
    @Override
    public List<ItemStack> redirectDrops(Block block) {  return ImmutableList.of(); }
